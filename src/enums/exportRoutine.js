...
export const exportTypeTextCZ = {
  ...
  [exportType.AIP_EXPORT_ALL_XMLS]: CZ.EXPORT_WHOLE_AIP_INCLUDING_ALL_XML_VERSIONS,
  [exportType.AIP_EXPORT_SINGLE_XML]: CZ.EXPORT_WHOLE_AIP_INCLUDING_LATEST_XML_VERSION,
};

export const exportTypeTextEN = {
  [exportType.XML_EXPORT]: EN.EXPORT_JUST_XML,
  [exportType.AIP_EXPORT_ALL_XMLS]: EN.EXPORT_WHOLE_AIP_INCLUDING_ALL_XML_VERSIONS,
  [exportType.AIP_EXPORT_SINGLE_XML]: EN.EXPORT_WHOLE_AIP_INCLUDING_LATEST_XML_VERSION,
};
