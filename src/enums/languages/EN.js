export const EN = {
  ...
  ARCHIVAL_STORAGE_IS_READ_ONLY_AT_THE_MOMENT:
    "Archival storage is read only at the moment.",
  ARCHIVIST: "Archivist",
  ASSIGNEE: "Assignee",
  ...
  AVAILABILITY_OF_STORAGES_LAST_CHECKED:
    "Availability of repositories last checked:",
  BATCH: "Batch",
  BATCH_FAILED_TO_RESUME:
    "Batch could not be resumed because of ongoing ingest workflows.",
  BATCH_HAS_SUCCESSFULLY_RESUMED: "Batch has successfully resumed.",
  BATCH_PROCESS_ONE_LOADER_TEXT:
    "Wait for completion of SIP package uploading.",
  ...
  ENTER_VALID_NUMBER_BIGGER_OR_EQUAL_1:
    "Enter a valid numeric value greater than or equal to 1.",
  ...
  OPENS_PAGE_WITH_CRON_EXPRESSION_INFORMATION:
    "Opens page with CRON expression information.",
  OPENS_PAGE_WITH_GLOB_PATTERN_INFORMATION:
    "Opens page with glob pattern information.",
  OPERATION: "Operation",
  ORGANISATION_NAME: "Organisation name",
  PAGINATION_COUNT_DIVIDER: "/",
  PASSWORD: "Password",
  PATH_TO_XML:
    "Path to XML file with authorial ID in the form of a glob pattern",
  ...
  REVERT_DELETION_REQUEST_TEXT:
    "Are you sure you want to revert deletion request",
  REVERTED: "Reverted",
  RISK: "Risk",
  ...
  SIP_METADATA_PATH:
    "Path to main metadata file of SIP (e.g. METS.xml) in the form of a glob pattern",
