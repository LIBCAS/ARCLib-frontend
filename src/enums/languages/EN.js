export const EN = {
  ...
  REINDEX_ARCLIB_XML_TEXT: 'Do you realy want to run reindex for all ARCLib XML stored in the system? The operation is time-consuming - all XMLs are downloaded from Archival Storage.',
  ...
  XPATH_TO_ID: 'XPath 3.1 (without namespace prefixes) to node with authorial ID in within XML file',
