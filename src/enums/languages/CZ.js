export const CZ = {
  ...
  LABEL: 'Označení',
  LAST_NAME: 'Příjmení',
  LATEST_VERSION_ONLY: 'Pouze poslední verze',
  LDAPDN: 'LdapDN',
  ...
  REINDEX_ARCLIB_XML_TEXT: 'Opravdu chcete spustit kompletní reindex všech ARCLib XML uložených v systému? Jedná se o časově náročnou operaci - všechna XML musí být vytažena z Archival Storage.',
