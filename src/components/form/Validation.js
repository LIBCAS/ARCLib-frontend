...
export const isLocalhostOrIPv4 = {
  [languages.CZ]: value =>
    localhostOrIPv4Check(value) ? undefined : CZ.ENTER_LOCALHOST_OR_IPv4,
  [languages.EN]: value =>
    localhostOrIPv4Check(value) ? undefined : EN.ENTER_LOCALHOST_OR_IPv4
};
...
export const enterCurrentOrFutureDate = {
  [languages.CZ]: value =>
    Date.parse(value) >= new Date().getTime()
      ? undefined
      : CZ.ENTER_CURRENT_OR_FUTURE_DATE,
  [languages.EN]: value =>
    Date.parse(value) < new Date().getTime()
      ? undefined
      : EN.ENTER_CURRENT_OR_FUTURE_DATE
};
