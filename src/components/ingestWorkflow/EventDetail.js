  ...
  <div>
    ...
    <div>
        ...
        <div {...{ className: 'margin-bottom-very-small' }}>
          ...
          <span
            {...{
              className: 'link',
              onClick: () =>
                history.push(`/issue-dictionary/${get(event, 'ingestIssueDefinition.id')}`),
            }}
      ...
      {get(event, 'formatDefinition') && (
        <div {...{ className: 'margin-bottom-very-small' }}>
          <span {...{ className: 'bold' }}>{`${texts.FORMAT_DEFINITION}: `}</span>
          <span
            {...{
              className: 'link',
              onClick: () =>
    ...
    <div {...{ className: 'flex-row flex-right' }}>
      <Button
        {...{
          onClick: () =>
            history.push(`/ingest-workflows/${get(workflow, 'ingestWorkflow.externalId')}`),
        }}
      >
        {texts.CLOSE}
      </Button>
