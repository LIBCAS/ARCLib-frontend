          ...
          <i
            {...{
              className: classNames('fas fa-circle margin-right-small', {
                ...
                'color-red':
                  !get(storage, 'reachable') || get(storageSyncStatus, 'stuckAt') !== null,
              }),
            }}
          />
          <strong>{`${
            ...
            !get(storage, 'reachable') ? texts.STORAGE_IS_UNAVAILABLE : texts.STORAGE_IS_AVAILABLE
          }`}</strong>
        </div>
        {editEnabled && (
          <Button
                ...
                <div>
                  <form {...{ onSubmit: handleSubmit }}>
                    ...
                    <div {...{ className: 'flex-row flex-right' }}>
                      <Button
                        {...{
                          onClick: () => history.push('/logical-storage-administration'),
                        }}
                      >
                  ...
                  <form>
                    <Row {...{ gutter: 16 }}>
                      {get(storageSyncStatus, 'phase') !== storageSyncStatusPhases.DONE &&
                        ...
                        editEnabled && (
                          <Col>
                            <div {...{ className: 'flex-row-normal flex-right' }}>
                              <Button
                                {...{
                                  onClick: () => {
                              ...
                              >
                                <i
                                  {...{
                                    className: 'fas fa-circle margin-right-very-small',
                                    style: { color: '#FF4136' },
                                  }}
                                />
                                {texts.CONTINUE_SYNC}
                      ...
                      {map(
                        [
                          ...
                          },
                          {
                            ...
                            type: 'textarea',
                            show: get(storageSyncStatus, 'exceptionStackTrace') !== null,
                          },
                        ],
                        ({ show, ...field }, key) =>
                          show && (
                      ...
                      <Table
                        {...{
                          ...
                          items: compact([
                            ...
                            ...map(get(storageStateData, 'pool'), (value, label) =>
                              !find(sortedFieldsZFSPool, (item) => item === label) &&
                              hasValue(value) &&
                              hasValue(label)
                                ? {
                                    items: [
                        ...
                        items: map(
                          compact([
                            ...map(sortedFieldsCEPH, (sortedField) =>
                              get(storage, 'storageType') === storageTypes.CEPH &&
                              ...
                              items: [
                                { label: <strong>{label}</strong>, field: 'key' },
                                {
                                  label:
                                    ...
                                    ) : find(formatedFieldsCEPH, (item) => item === label) ? (
                                      <pre
                                        {...{
                                          style: {
                                            borderWidth: 0,
