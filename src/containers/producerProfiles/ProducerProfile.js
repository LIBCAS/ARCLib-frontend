...
const ProducerProfile = ({ history, producerProfile, getProducerProfile, texts, ...props }) => (
  <PageWrapper
    {...{
      breadcrumb: [
      ...
      <Detail
        {...{
          ...
          initialValues: {
            ...
            workflowDefinition: get(producerProfile, 'workflowDefinition.id', ''),
            workflowConfig: prettyJSON(get(producerProfile, 'workflowConfig', '')),
          },
          ...props,
        }}
      />
